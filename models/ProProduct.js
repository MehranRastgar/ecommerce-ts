  ...
  variants: [
    {
      ...
      seller: { type: Object},
      shipment_methods: {
        description:{ type: String, default:"موجود در انبار فروشنده و شاپسو" },
        has_lead_time: {type:Boolean},
        providers: [
          {
            title:{ type: String, default:"موجود در انبار" }, 
            description: { type: String, default:"این کالا توسط پیک فروشگاه ارسال میشود" },
            has_lead_time: {type:Boolean},
            type:  { type: String, default:"shopsoo", enum:["shopsoo","seller"]},
          },
        ],
      },
      color: {
