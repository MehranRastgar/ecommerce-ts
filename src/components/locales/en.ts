const en: { [key: string]: string } = {
  ...
  arvantaMap: "arvanta Map",
  aboutUs: "About Us",
  contactUs: "Contact Us",
  saleInarvanta: "Sale In arvanta",
  ...
  register: "Register",
  copyRight:
    "© 2022 arvanta. All rights reserved - Designed and Developed with ",
  sort: "Sort based on: ",
  all: "All",
