...
export const getServerSideProps: GetServerSideProps = async (context) => {
  try {
    ...
    const category: string = context?.query?.category?.toString() ?? "nothing";
    ...
    const categoryyy: string | undefined =
...
const GetProducts = async (
  ...
  const categoryL1Object: any = {
    category: { "category.L1": query?.category, "category.L2": query?.subcat },
  };
  //   { "category.L1": "laptop" }
