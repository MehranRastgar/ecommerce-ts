...
export default function CartPage() {
  ...
  return (
    <>
      ...
      <div className="select-none flex flex-wrap h-fit font-Vazir-Bold justify-center items-start w-full max-w-[500px]">
        ...
        {userInfo?.firstname !== undefined ? (
          <>
            <div className="flex w-full flex-wrap border mt-4 rounded-md text-gray-600 text-xs">
